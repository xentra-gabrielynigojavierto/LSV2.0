...
description: |
  Provides comprehensive code review guidance for React 19, Vue 3, Rust, TypeScript, Java, Python, C/C++, and C#.
...
| **C#** | [C# Guide](reference/csharp.md) | IDisposable, Nullable refs, Async/Await, Records, LINQ, Span\<T\> |
