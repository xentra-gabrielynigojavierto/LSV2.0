...
export default function CaseDetailError({
  ...
  return (
    <div className="p-10 text-center space-y-4">
      ...
      <h2 className="text-lg font-semibold text-gray-800">Unable to load case</h2>
      ...
      <div className="flex items-center justify-center gap-3 pt-2">
        ...
        <Link
          href="/lien/cases"
          className="text-sm font-medium px-4 py-2 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50 transition-colors"
        >
          Back to Cases
        </Link>
      </div>
